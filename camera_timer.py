...
'''
    if titles are different windows will change else same ones
    ret stores the frames
    cap read to capture the webcam :on cap function we apply read function to store image in frame
